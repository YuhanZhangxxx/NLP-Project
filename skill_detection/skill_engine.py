...
SKILL_REGISTRY = [
    ...
    ("double_team",         "DT",   "Double Team",           +1.20, "highlight", 0.40),
    ("layup",               "LU",   "Layup",                 +1.25, "highlight", 0.40),
    ("rebound",             "REB",  "Rebound",               +1.15, "highlight", 0.40),
    ("and_1_block",         "A1B",  "And-1 Block",           +1.10, "highlight", 0.40),
    ("box_out",             "BOX",  "Box Out",               +1.00, "highlight", 0.40),
    ("no_look_pass",        "NLP",  "No-Look Pass",          +0.90, "highlight", 0.40),
    ("pump_fake",           "PF",   "Pump Fake",             +0.85, "highlight", 0.40),
    ("floater",             "FL",   "Floater",               +0.75, "highlight", 0.35),
    ("tip_in",              "TIP",  "Tip-In",                +0.60, "highlight", 0.40),
    ("block",               "BLK",  "Block",                 +0.50, "highlight", 0.40),
    ("made_free_throw",     "MFT",  "Made Free Throw",       +0.25, "highlight", 0.35),
    ("missed_free_throw",   "XFT",  "Missed Free Throw",     -0.25, "mistake",   0.45),
    # ---- Mistakes (negative) ----
